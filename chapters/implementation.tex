...
In this implementation, we create a Python script, dypybench.py, which acts as a single point of entry to trigger the execution of various tasks within the benchmark.
...
In our implementation, we provide the files to be instrumented inside a text file as a list.
...
In this implementation, we provide two such text files for instrumentation, one which includes all the source files and the test files and the other which excludes test files.
